...
const ProductDetails = () => {
  ...
  useEffect(() => {
    const productsData = ProductData.Products.filter((data) => data.title === title)
                  ...
                  <div className="product-detail-info bg-gray p-a30">
                    <div className="wt-product-title ">
                      <h2  className="post-title">
                        <NavLink to={"#"}><h3 style={{fontSize: '30px'}}>{title}</h3></NavLink>
                      </h2>
                    </div>
                    <h4 className="m-tb10"> {Data.price} </h4> 
